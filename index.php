<?php
$bdd = new PDO('mysql:host=portfoliqdhugo.mysql.db;dbname=portfoliqdhugo', 'portfoliqdhugo', 'Didoua59');
      ...
      if ($pseudolength <= 255) {
         if ($mail == $mail2) {
            if (filter_var($mail, FILTER_VALIDATE_EMAIL)) {
               ...
               if ($mailexist == 0) {
                  if ($mdp == $mdp2) {
                     $insertmbr = $bdd->prepare("INSERT INTO test(pseudo, mail, mdp) VALUES(?, ?, ?)");
